    ...
    content:
      ...
      text: |-
        ...
        <div class="visit-panel" style="width:min(94vw,800px);margin:28px auto 0;">
          ...
          <h3 class="visit-heading">Visitor Statistics</h3>
          <div class="visit-grid">
            <section class="visit-counter">
              ...
              <p class="visit-note">Static preview does not record real IPs. This panel is ready for a future visit-statistics API.</p>
            </section>
            <section class="visit-map" aria-label="visitor map">
              <svg viewBox="0 0 640 330" role="img">
                ...
                <circle class="visit-point" cx="458" cy="142" r="0"><title>No real visit data yet</title></circle>
                <circle class="visit-last" cx="458" cy="142" r="0"><title>No last-visitor data yet</title></circle>
              </svg>
              <div class="visit-tooltip">No real visit data yet. A backend statistics API can later aggregate China/US by province or state and other regions by country.</div>
            </section>
          </div>
        </div>
    design:
